...
class ThemedCalculator:
    def __init__(self, root):
        self.root = root
        self.root.title("Calculator - Purple + Teal Theme")
        self.root.geometry("360x500")
        self.root.resizable(False, False)
        self.expression = ""

        # Colors - Purple + Teal theme
        self.bg_color = "#2a0b4a"    # Dark purple background
        self.btn_color = "#4a1b6d"   # Lighter purple for buttons
        self.btn_text = "#ffffff"    # White text
        self.ac_color = "#00c2c7"    # Teal for AC
        self.eq_color = "#00c2c7"    # Teal for =
